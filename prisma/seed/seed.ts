...
async function main() {
  const hospitalBeds = await prisma.category.upsert({
    where: { name: 'Hospital Beds' },
    update: {},
    create: {
      name: 'Hospital Beds',
    },
  ...
  const syringes = await prisma.category.upsert({
    where: { name: 'Syringes & Needles' },
    update: {},
    create: {
  ...
  const wheelchairs = await prisma.category.upsert({
    where: { name: 'Wheelchairs' },
    update: {},
    create: {
      name: 'Wheelchairs',
    },
  ...
  const sanitizers = await prisma.category.upsert({
    where: { name: 'Alcohols & Sanitizers' },
    update: {},
    create: {
      name: 'Alcohols & Sanitizers',
    },
  });
